...
COLORS_NAMES = [BLACK, GRAY_DARK, GRAY_LIGHT, WHITE, YELLOW, YELLOW_DARK, ORANGE, ORANGE_DARK, RED, RED_DARK, PINK, PINK_DARK, PURPLE, BLUE, CYAN, TURQUOISE, TURQUOISE_DARK, GREEN, LIME]
