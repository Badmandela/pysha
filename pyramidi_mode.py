...
class MIDICCControl(object):
    ...
    def draw(self, ctx, x, y):
        ...
        show_title(ctx, x, y, self.name, color=definitions.get_color_rgb_float(definitions.WHITE))
